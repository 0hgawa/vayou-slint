...
// The display-server connection, handed over at context creation. This is what
// lets libmpv open a VA display and hardware-decode: without it the interop
// cannot be initialised and mpv falls back to software decoding in silence.
// Unused on Windows, where the GL context alone carries what the interop needs.
#[cfg(unix)]
